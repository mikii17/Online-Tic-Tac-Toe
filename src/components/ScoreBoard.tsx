        ...
        <div className="pt-5 flex justify-center items-center gap-20">
            <div className="flex flex-col gap-3">
                <img src={avatarUri1} alt="avatar for user one" className={` rounded-full ${
                    turn === 0 ? "outline-4 outline outline-[rgb(--color-text-muted)] -outline-offset-2 scale-105" : ""} transition-all duration-100 ease-linear rounded-[50%]` } />
            ...
            <div className="flex flex-col gap-3">
                <img src={avatarUri2} alt="avatar for user two" className={` rounded-full ${
                    turn === 1 ? "outline-4 outline outline-[rgb(--color-text-muted)] -outline-offset-2 scale-105" : ""} transition-all duration-100 ease-linear` }/>
