import { Form, useNavigation, useActionData, Navigate, useParams } from "react-router-dom";
    ...
    <div>
      <h1>Join</h1>
        <Form method="POST">
            ...
            <input type="text" placeholder="roomId" name="roomId" value={roomId} onChange={handleOnChange}/>
